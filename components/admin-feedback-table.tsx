                            ...
                            return (
                                <TableRow key={post.id} className="h-[70px]">
                                    ...
                                    <TableCell className="align-middle" >
                                        <Badge variant="outline" className={`${categoryDesign.border} ${categoryDesign.text}`}><CategoryIcon className="h-3 w-3" />{post.category}</Badge>
                                    </TableCell>
                                    <TableCell className="align-middle">
                                    ...
                                    <TableCell className="align-middle">
                                        {isEditing ? <>
                                            ...
                                            <Button size='sm' variant={"ghost"} onClick={()=>cancelEditing(post.id)} className="gap-1 h-8" >
                                                <X className="h-3 w-3" />
                                            </Button>
                                            
                                        </> : <>
                                            <Button size='sm' variant="outline" onClick={()=>startEditing(post.id)} className="gap-1 h-8" >
