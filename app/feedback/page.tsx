...
import { getCategoryDesign } from "../api/data/category-data";
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                            ...
                            <CardContent>
                                <div className="space-y3">
                                    {categories.map((cat)=>{
                                        ...
                                        return <div key={cat.category} className="group flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-colors cursor-pointe">
                    ...
                    <div className="lg:col-span-3">
                        <FeedbackList userId={userId} initialPosts={posts}/>
