...
import { BarChart, CheckCheck, Clock, Target } from "lucide-react"
import { STATUS_GROUPS, STATUS_ORDER } from "../api/data/status-data"
...
export default async function RoadmapPage(){
    ...
    return (
        ...
        <Header title="Product Roadmap" subtitle="See what we're working on" />
            ...
            <Card>
                ...
                <CardContent className="spacy-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-5">
                        ...
                        <div className="text-center">
                            <div className="text-2xl font-bold text-green-600 dark:text-yellow-400">
                                {completedPercentage}%
                            </div>
        ...
        {STATUS_ORDER.map((status) => {
          ...
          return (
            <div key={status} className="space-y-4">
              <div
                className={`rounded-lg p-4  border ${group.color}`}>
